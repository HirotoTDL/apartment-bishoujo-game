...
export const SKILLS: Record<string, Skill> = {
  ...
  s_heal: {
    ...
    element: "light",
    kind: "heal", mpCost: 10, target: "single_ally",
    effects: [{ type: "heal", power: 100 }],
  },
  s_aqua_cure: {
    id: "s_aqua_cure",
    name: "アクアキュア",
    description: "味方単体のHP大回復+毒/やけど解除",
    element: "water",
    kind: "heal", mpCost: 18, target: "single_ally",
    effects: [{ type: "heal", power: 150 }, { type: "cleanse" }],
  },
  s_group_heal: {
    id: "s_group_heal",
    name: "グループヒール",
    ...
    element: "light",
    kind: "heal", mpCost: 22, target: "all_allies",
    effects: [{ type: "heal", power: 70 }],
  },
  s_regen_song: {
    id: "s_regen_song",
    name: "リジェネレートソング",
    ...
    element: "wood",
    kind: "heal", mpCost: 20, target: "all_allies",
    effects: [{ type: "status", status: "regen", chance: 1, turns: 3 }],
  },
  s_world_tree: {
    id: "s_world_tree",
    name: "世界樹の祝福",
    description: "味方全体を大回復+再生",
    element: "wood",
    kind: "heal", mpCost: 32, target: "all_allies",
    effects: [{ type: "heal", power: 120 }, { type: "status", status: "regen", chance: 1, turns: 3 }],
  },
  s_revive: {
    id: "s_revive",
    name: "リバイブ",
    description: "倒れた味方を50%HPで蘇生",
    element: "light",
    kind: "heal", mpCost: 28, target: "single_dead_ally",
    effects: [{ type: "revive", revivePct: 50 }],
  },
